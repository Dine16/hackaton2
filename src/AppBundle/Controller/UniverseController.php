...
class UniverseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $universes = $em->getRepository('AppBundle:Universe')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\UniverseType', $universe);
    ...
    {
        $deleteForm = $this->createDeleteForm($universe);
        $editForm = $this->createForm('AppBundle\Form\UniverseType', $universe);
